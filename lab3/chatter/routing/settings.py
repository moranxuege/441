...
SECRET_KEY = 'django-insecure-46h8m6c$m6#%j1l8$-4!3^j*9t6y+pel=ming5!vyawz7z526b'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['118.178.123.192', 'localhost', '127.0.0.1']
...
MEDIA_URL = 'https://118.178.123.192/media/'
